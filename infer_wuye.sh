...
VIDEO_WORKERS=2
OOS_ANNOTATION_JSON="/mnt/FileExchange/users/zhouyang/instruments/data/五叶牵拉钳_box_dict_light.json"
...
INPUT_VIDEO_DIR="/mnt/FileExchange/users/zhouyang/instruments/data/五叶牵拉钳"
INPUT_VIDEO_LIST=""
# INPUT_VIDEO_LIST="/mnt/data/projects/instruments/annos/predic_17416_20260425_excluded_random100_paths.txt"
INPUT_IMAGE=""
INPUT_IMAGE_DIR=""
OUTPUT_PATH=""
OUTPUT_DIR="/mnt/FileExchange/users/zhouyang/instruments/test/五叶牵拉钳"
...
if [[ "$MODE" == "video" ]]; then
    python tools/media_instance_infer_wuye.py \
        "${COMMON_ARGS[@]}" \
        --mode video \
